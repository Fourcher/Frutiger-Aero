...
.web-sc-nowtop h1 { margin: 0; font: 400 1.9em/1.2 "Segoe UI", Selawik, "Trebuchet MS", sans-serif; }
...
.web-sc-temp { font: 300 4.4em/1 "Segoe UI", Selawik, sans-serif; display: flex; flex-direction: column; }
...
.web-sc-h2 { font: 400 1.4em "Segoe UI", Selawik, sans-serif; color: #0d3f78; margin: 20px 0 10px; }
...
.web-sc-h1 { font: 400 1.8em "Segoe UI", Selawik, sans-serif; color: #0d3f78; margin: 16px 0 4px; }
...
`,
  ...
  W.register({
    ...
    css: `
.web-gl { min-height: 100%; background: #fff; color: #333; font: calc(13px * var(--hz-text, 1))/1.5 "Lucida Grande", "Segoe UI", Tahoma, Verdana, sans-serif; }
...
.web-gl-pitch { flex: 1; }
.web-gl-pitch h1 { font: 300 3.2em/1.1 "Segoe UI", Selawik, "Lucida Grande", sans-serif; color: #222; margin: 34px 0 10px; letter-spacing: -.02em; }
...
.web-gl-cloudbox h2, .web-gl-quotes h2, .web-gl-photol h2 { font: 400 1.25em "Segoe UI", Selawik, sans-serif; color: #444; margin: 0 0 8px; }
...
.web-gl-h1 { font: 300 2.2em/1.2 "Segoe UI", Selawik, sans-serif; color: #222; margin: 0 0 14px; }
